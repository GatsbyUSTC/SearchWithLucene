...
/**
 * Servlet implementation class _deleteonedoc
 */
@WebServlet("/_deleteonedoc")
public class _deleteonedoc extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		Deleter.delete(requestJson, indexPath);
